...
/**
 * This is the item provider adapter for a {@link org.eclipse.soa.sca.sca1_1.model.sca.Binding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BindingItemProvider
	...
	protected void addPolicySetsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Binding_policySets_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Binding_policySets_feature", "_UI_Binding_type"),
				 ScaPackage.eINSTANCE.getBinding_PolicySets(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addRequiresPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Binding_requires_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Binding_requires_feature", "_UI_Binding_type"),
				 ScaPackage.eINSTANCE.getBinding_Requires(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ScaPackage.eINSTANCE.getBinding_Uri(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScaPackage.eINSTANCE.getBinding_WireFormatGroup());
			childrenFeatures.add(ScaPackage.eINSTANCE.getBinding_OperationSelectorGroup());
		}
