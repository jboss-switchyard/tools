...
/**
 * This is the item provider adapter for a {@link org.switchyard.tools.models.switchyard1_0.jca.Connection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectionItemProvider
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(JcaPackage.Literals.CONNECTION__PROPERTY);
            childrenFeatures.add(JcaPackage.Literals.CONNECTION__ANY);
            childrenFeatures.add(JcaPackage.Literals.CONNECTION__ANY_ATTRIBUTE);
        }
    ...
    public String getText(Object object) {
        String label = ((Connection)object).getJndiName();
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (JcaPackage.Literals.CONNECTION__PROPERTY,
                 JcaFactory.eINSTANCE.createProperty()));

        newChildDescriptors.add
            (createChildParameter
                (JcaPackage.Literals.CONNECTION__ANY,
