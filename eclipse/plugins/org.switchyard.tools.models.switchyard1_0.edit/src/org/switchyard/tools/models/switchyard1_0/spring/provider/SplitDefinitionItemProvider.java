...
/**
 * This is the item provider adapter for a {@link org.switchyard.tools.models.switchyard1_0.spring.SplitDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SplitDefinitionItemProvider
     ...
     * @generated
     */
    public SplitDefinitionItemProvider(AdapterFactory adapterFactory) {
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_SplitDefinition_executorServiceRef_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_SplitDefinition_executorServiceRef_feature", "_UI_SplitDefinition_type"),
                 SpringPackage.eINSTANCE.getSplitDefinition_ExecutorServiceRef(),
                 true,
                 false,
                 false,
    ...
    protected void addOnPrepareRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_SplitDefinition_onPrepareRef_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_SplitDefinition_onPrepareRef_feature", "_UI_SplitDefinition_type"),
                 SpringPackage.eINSTANCE.getSplitDefinition_OnPrepareRef(),
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addParallelProcessingPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_SplitDefinition_parallelProcessing_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_SplitDefinition_parallelProcessing_feature", "_UI_SplitDefinition_type"),
                 SpringPackage.eINSTANCE.getSplitDefinition_ParallelProcessing(),
                 true,
                 false,
                 false,
    ...
    protected void addShareUnitOfWorkPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_SplitDefinition_shareUnitOfWork_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_SplitDefinition_shareUnitOfWork_feature", "_UI_SplitDefinition_type"),
                 SpringPackage.eINSTANCE.getSplitDefinition_ShareUnitOfWork(),
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
    ...
    protected void addStopOnExceptionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_SplitDefinition_stopOnException_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_SplitDefinition_stopOnException_feature", "_UI_SplitDefinition_type"),
                 SpringPackage.eINSTANCE.getSplitDefinition_StopOnException(),
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
    ...
    protected void addStrategyRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_SplitDefinition_strategyRef_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_SplitDefinition_strategyRef_feature", "_UI_SplitDefinition_type"),
                 SpringPackage.eINSTANCE.getSplitDefinition_StrategyRef(),
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addStreamingPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_SplitDefinition_streaming_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_SplitDefinition_streaming_feature", "_UI_SplitDefinition_type"),
                 SpringPackage.eINSTANCE.getSplitDefinition_Streaming(),
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
    ...
    protected void addTimeoutPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_SplitDefinition_timeout_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_SplitDefinition_timeout_feature", "_UI_SplitDefinition_type"),
                 SpringPackage.eINSTANCE.getSplitDefinition_Timeout(),
                 true,
                 false,
                 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(SpringPackage.eINSTANCE.getSplitDefinition_AnyAttribute2());
        }
    ...
    /**
     * This returns SplitDefinition.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/SplitDefinition"));
    }
    ...
    public String getText(Object object) {
        String label = ((SplitDefinition)object).getId();
        return label == null || label.length() == 0 ?
            getString("_UI_SplitDefinition_type") :
            getString("_UI_SplitDefinition_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(SplitDefinition.class)) {
