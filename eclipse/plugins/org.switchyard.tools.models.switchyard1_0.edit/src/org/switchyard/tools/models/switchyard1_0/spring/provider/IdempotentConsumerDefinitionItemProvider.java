...
/**
 * This is the item provider adapter for a {@link org.switchyard.tools.models.switchyard1_0.spring.IdempotentConsumerDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IdempotentConsumerDefinitionItemProvider
     ...
     * @generated
     */
    public IdempotentConsumerDefinitionItemProvider(AdapterFactory adapterFactory) {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addMessageIdRepositoryRefPropertyDescriptor(object);
            addRemoveOnFailurePropertyDescriptor(object);
            addSkipDuplicatePropertyDescriptor(object);
        }
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_IdempotentConsumerDefinition_eager_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_IdempotentConsumerDefinition_eager_feature", "_UI_IdempotentConsumerDefinition_type"),
                 SpringPackage.eINSTANCE.getIdempotentConsumerDefinition_Eager(),
                 true,
                 false,
                 false,
    ...
    /**
     * This adds a property descriptor for the Message Id Repository Ref feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected void addMessageIdRepositoryRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_IdempotentConsumerDefinition_messageIdRepositoryRef_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_IdempotentConsumerDefinition_messageIdRepositoryRef_feature", "_UI_IdempotentConsumerDefinition_type"),
                 SpringPackage.eINSTANCE.getIdempotentConsumerDefinition_MessageIdRepositoryRef(),
                 true,
                 false,
                 false,
    ...
    /**
     * This adds a property descriptor for the Remove On Failure feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected void addRemoveOnFailurePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_IdempotentConsumerDefinition_removeOnFailure_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_IdempotentConsumerDefinition_removeOnFailure_feature", "_UI_IdempotentConsumerDefinition_type"),
                 SpringPackage.eINSTANCE.getIdempotentConsumerDefinition_RemoveOnFailure(),
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
    ...
    /**
     * This adds a property descriptor for the Skip Duplicate feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected void addSkipDuplicatePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_IdempotentConsumerDefinition_skipDuplicate_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_IdempotentConsumerDefinition_skipDuplicate_feature", "_UI_IdempotentConsumerDefinition_type"),
                 SpringPackage.eINSTANCE.getIdempotentConsumerDefinition_SkipDuplicate(),
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(SpringPackage.eINSTANCE.getIdempotentConsumerDefinition_AnyAttribute2());
        }
    ...
    /**
     * This returns IdempotentConsumerDefinition.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/IdempotentConsumerDefinition"));
    }
    ...
    public String getText(Object object) {
        String label = ((IdempotentConsumerDefinition)object).getId();
        return label == null || label.length() == 0 ?
            getString("_UI_IdempotentConsumerDefinition_type") :
            getString("_UI_IdempotentConsumerDefinition_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(IdempotentConsumerDefinition.class)) {
