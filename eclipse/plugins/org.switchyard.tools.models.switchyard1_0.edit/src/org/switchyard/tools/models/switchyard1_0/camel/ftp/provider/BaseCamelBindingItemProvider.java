...
public class BaseCamelBindingItemProvider
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(FtpPackage.Literals.BASE_CAMEL_BINDING__CONTEXT_MAPPER);
            childrenFeatures.add(FtpPackage.Literals.BASE_CAMEL_BINDING__MESSAGE_COMPOSER);
            childrenFeatures.add(FtpPackage.Literals.BASE_CAMEL_BINDING__ADDITIONAL_URI_PARAMETERS);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (FtpPackage.Literals.BASE_CAMEL_BINDING__ADDITIONAL_URI_PARAMETERS,
                 FtpFactory.eINSTANCE.createAdditionalUriParametersType()));
    }
