...
/**
 * This is the item provider adapter for a {@link org.switchyard.tools.models.switchyard1_0.spring.DelayDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DelayDefinitionItemProvider
     ...
     * @generated
     */
    public DelayDefinitionItemProvider(AdapterFactory adapterFactory) {
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_DelayDefinition_asyncDelayed_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_DelayDefinition_asyncDelayed_feature", "_UI_DelayDefinition_type"),
                 SpringPackage.eINSTANCE.getDelayDefinition_AsyncDelayed(),
                 true,
                 false,
                 false,
    ...
    protected void addCallerRunsWhenRejectedPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_DelayDefinition_callerRunsWhenRejected_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_DelayDefinition_callerRunsWhenRejected_feature", "_UI_DelayDefinition_type"),
                 SpringPackage.eINSTANCE.getDelayDefinition_CallerRunsWhenRejected(),
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
    ...
    protected void addExecutorServiceRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_DelayDefinition_executorServiceRef_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_DelayDefinition_executorServiceRef_feature", "_UI_DelayDefinition_type"),
                 SpringPackage.eINSTANCE.getDelayDefinition_ExecutorServiceRef(),
                 true,
                 false,
                 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(SpringPackage.eINSTANCE.getDelayDefinition_AnyAttribute2());
        }
    ...
    /**
     * This returns DelayDefinition.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/DelayDefinition"));
    }
    ...
    public String getText(Object object) {
        String label = ((DelayDefinition)object).getId();
        return label == null || label.length() == 0 ?
            getString("_UI_DelayDefinition_type") :
            getString("_UI_DelayDefinition_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(DelayDefinition.class)) {
