...
/**
 * This is the item provider adapter for a {@link org.switchyard.tools.models.switchyard1_0.spring.SetHeaderDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SetHeaderDefinitionItemProvider
     ...
     * @generated
     */
    public SetHeaderDefinitionItemProvider(AdapterFactory adapterFactory) {
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_SetHeaderDefinition_headerName_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_SetHeaderDefinition_headerName_feature", "_UI_SetHeaderDefinition_type"),
                 SpringPackage.eINSTANCE.getSetHeaderDefinition_HeaderName(),
                 true,
                 false,
                 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(SpringPackage.eINSTANCE.getSetHeaderDefinition_AnyAttribute3());
        }
    ...
    /**
     * This returns SetHeaderDefinition.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/SetHeaderDefinition"));
    }
    ...
    public String getText(Object object) {
        String label = ((SetHeaderDefinition)object).getId();
        return label == null || label.length() == 0 ?
            getString("_UI_SetHeaderDefinition_type") :
            getString("_UI_SetHeaderDefinition_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(SetHeaderDefinition.class)) {
