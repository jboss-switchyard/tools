...
/**
 * This is the item provider adapter for a {@link org.switchyard.tools.models.switchyard1_0.resteasy.BasicAuthenticationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 ResteasyPackage.Literals.BASIC_AUTHENTICATION_TYPE__USER,
                 true,
                 false,
                 false,
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 ResteasyPackage.Literals.BASIC_AUTHENTICATION_TYPE__PASSWORD,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addRealmPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_BasicAuthenticationType_realm_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_BasicAuthenticationType_realm_feature", "_UI_BasicAuthenticationType_type"),
                 ResteasyPackage.Literals.BASIC_AUTHENTICATION_TYPE__REALM,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addHostPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_BasicAuthenticationType_host_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_BasicAuthenticationType_host_feature", "_UI_BasicAuthenticationType_type"),
                 ResteasyPackage.Literals.BASIC_AUTHENTICATION_TYPE__HOST,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addPortPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_BasicAuthenticationType_port_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_BasicAuthenticationType_port_feature", "_UI_BasicAuthenticationType_type"),
                 ResteasyPackage.Literals.BASIC_AUTHENTICATION_TYPE__PORT,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
