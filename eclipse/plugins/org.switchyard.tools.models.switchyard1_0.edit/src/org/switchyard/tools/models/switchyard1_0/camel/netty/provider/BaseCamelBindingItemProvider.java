...
public class BaseCamelBindingItemProvider
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(NettyPackage.Literals.BASE_CAMEL_BINDING__CONTEXT_MAPPER);
            childrenFeatures.add(NettyPackage.Literals.BASE_CAMEL_BINDING__MESSAGE_COMPOSER);
            childrenFeatures.add(NettyPackage.Literals.BASE_CAMEL_BINDING__ADDITIONAL_URI_PARAMETERS);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (NettyPackage.Literals.BASE_CAMEL_BINDING__ADDITIONAL_URI_PARAMETERS,
                 NettyFactory.eINSTANCE.createAdditionalUriParametersType()));
    }
