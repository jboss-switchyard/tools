...
public class BaseCamelBindingItemProvider
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(CorePackage.Literals.BASE_CAMEL_BINDING__CAMEL_CONTEXT_MAPPER);
            childrenFeatures.add(CorePackage.Literals.BASE_CAMEL_BINDING__CAMEL_MESSAGE_COMPOSER);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (CorePackage.Literals.BASE_CAMEL_BINDING__CAMEL_CONTEXT_MAPPER,
        ...
        newChildDescriptors.add
            (createChildParameter
                (CorePackage.Literals.BASE_CAMEL_BINDING__CAMEL_MESSAGE_COMPOSER,
