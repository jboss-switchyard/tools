...
/**
 * This is the item provider adapter for a {@link org.switchyard.tools.models.switchyard1_0.spring.RoutingSlipDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoutingSlipDefinitionItemProvider
     ...
     * @generated
     */
    public RoutingSlipDefinitionItemProvider(AdapterFactory adapterFactory) {
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_RoutingSlipDefinition_ignoreInvalidEndpoints_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_RoutingSlipDefinition_ignoreInvalidEndpoints_feature", "_UI_RoutingSlipDefinition_type"),
                 SpringPackage.eINSTANCE.getRoutingSlipDefinition_IgnoreInvalidEndpoints(),
                 true,
                 false,
                 false,
    ...
    protected void addUriDelimiterPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_RoutingSlipDefinition_uriDelimiter_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_RoutingSlipDefinition_uriDelimiter_feature", "_UI_RoutingSlipDefinition_type"),
                 SpringPackage.eINSTANCE.getRoutingSlipDefinition_UriDelimiter(),
                 true,
                 false,
                 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(SpringPackage.eINSTANCE.getRoutingSlipDefinition_AnyAttribute3());
        }
    ...
    /**
     * This returns RoutingSlipDefinition.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/RoutingSlipDefinition"));
    }
    ...
    public String getText(Object object) {
        String label = ((RoutingSlipDefinition)object).getId();
        return label == null || label.length() == 0 ?
            getString("_UI_RoutingSlipDefinition_type") :
            getString("_UI_RoutingSlipDefinition_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(RoutingSlipDefinition.class)) {
