...
/**
 * This is the item provider adapter for a {@link org.switchyard.tools.models.switchyard1_0.spring.SetOutHeaderDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SetOutHeaderDefinitionItemProvider
     ...
     * @generated
     */
    public SetOutHeaderDefinitionItemProvider(AdapterFactory adapterFactory) {
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_SetOutHeaderDefinition_headerName_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_SetOutHeaderDefinition_headerName_feature", "_UI_SetOutHeaderDefinition_type"),
                 SpringPackage.eINSTANCE.getSetOutHeaderDefinition_HeaderName(),
                 true,
                 false,
                 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(SpringPackage.eINSTANCE.getSetOutHeaderDefinition_AnyAttribute3());
        }
    ...
    /**
     * This returns SetOutHeaderDefinition.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/SetOutHeaderDefinition"));
    }
    ...
    public String getText(Object object) {
        String label = ((SetOutHeaderDefinition)object).getId();
        return label == null || label.length() == 0 ?
            getString("_UI_SetOutHeaderDefinition_type") :
            getString("_UI_SetOutHeaderDefinition_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(SetOutHeaderDefinition.class)) {
