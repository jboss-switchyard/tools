...
/**
 * This is the item provider adapter for a {@link org.switchyard.tools.models.switchyard1_0.jca.Operation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 JcaPackage.Literals.OPERATION__NAME,
                 true,
                 false,
                 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(JcaPackage.Literals.OPERATION__INTERACTION_SPEC);
            childrenFeatures.add(JcaPackage.Literals.OPERATION__ANY);
            childrenFeatures.add(JcaPackage.Literals.OPERATION__ANY_ATTRIBUTE);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (JcaPackage.Literals.OPERATION__INTERACTION_SPEC,
                 JcaFactory.eINSTANCE.createInteractionSpec()));

        newChildDescriptors.add
            (createChildParameter
                (JcaPackage.Literals.OPERATION__ANY,
