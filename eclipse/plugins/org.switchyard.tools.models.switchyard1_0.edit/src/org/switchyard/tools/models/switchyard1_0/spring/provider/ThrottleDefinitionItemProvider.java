...
/**
 * This is the item provider adapter for a {@link org.switchyard.tools.models.switchyard1_0.spring.ThrottleDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ThrottleDefinitionItemProvider
     ...
     * @generated
     */
    public ThrottleDefinitionItemProvider(AdapterFactory adapterFactory) {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addAsyncDelayedPropertyDescriptor(object);
            addCallerRunsWhenRejectedPropertyDescriptor(object);
            addExecutorServiceRefPropertyDescriptor(object);
            addTimePeriodMillisPropertyDescriptor(object);
        }
        return itemPropertyDescriptors;
    }

    /**
     * This adds a property descriptor for the Async Delayed feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected void addAsyncDelayedPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ThrottleDefinition_asyncDelayed_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ThrottleDefinition_asyncDelayed_feature", "_UI_ThrottleDefinition_type"),
                 SpringPackage.eINSTANCE.getThrottleDefinition_AsyncDelayed(),
                 true,
                 false,
                 false,
    ...
    protected void addCallerRunsWhenRejectedPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ThrottleDefinition_callerRunsWhenRejected_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ThrottleDefinition_callerRunsWhenRejected_feature", "_UI_ThrottleDefinition_type"),
                 SpringPackage.eINSTANCE.getThrottleDefinition_CallerRunsWhenRejected(),
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
    ...
    protected void addExecutorServiceRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ThrottleDefinition_executorServiceRef_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ThrottleDefinition_executorServiceRef_feature", "_UI_ThrottleDefinition_type"),
                 SpringPackage.eINSTANCE.getThrottleDefinition_ExecutorServiceRef(),
                 true,
                 false,
                 false,
    ...
    /**
     * This adds a property descriptor for the Time Period Millis feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected void addTimePeriodMillisPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ThrottleDefinition_timePeriodMillis_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ThrottleDefinition_timePeriodMillis_feature", "_UI_ThrottleDefinition_type"),
                 SpringPackage.eINSTANCE.getThrottleDefinition_TimePeriodMillis(),
                 true,
                 false,
                 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(SpringPackage.eINSTANCE.getThrottleDefinition_AnyAttribute2());
        }
    ...
    /**
     * This returns ThrottleDefinition.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/ThrottleDefinition"));
    }
    ...
    public String getText(Object object) {
        String label = ((ThrottleDefinition)object).getId();
        return label == null || label.length() == 0 ?
            getString("_UI_ThrottleDefinition_type") :
            getString("_UI_ThrottleDefinition_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(ThrottleDefinition.class)) {
