...
public class AmqpPackageImpl extends EPackageImpl implements AmqpPackage {
    ...
    public void initializePackageContents() {
        ...
        initEAttribute(getCamelAmqpBindingType_ConcurrentConsumers(), theXMLTypePackage.getInt(), "concurrentConsumers", "1", 0, 1, CamelAmqpBindingType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getCamelAmqpBindingType_MaxConcurrentConsumers(), theXMLTypePackage.getInt(), "maxConcurrentConsumers", "1", 0, 1, CamelAmqpBindingType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
