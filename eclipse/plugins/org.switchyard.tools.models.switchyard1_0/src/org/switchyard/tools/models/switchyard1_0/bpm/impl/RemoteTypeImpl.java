 ...
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.bpm.impl.RemoteTypeImpl#getExtraJaxbClasses <em>Extra Jaxb Classes</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.bpm.impl.RemoteTypeImpl#getDeploymentId <em>Deployment Id</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.bpm.impl.RemoteTypeImpl#getPassword <em>Password</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.bpm.impl.RemoteTypeImpl#getTimeout <em>Timeout</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.bpm.impl.RemoteTypeImpl#getUserName <em>User Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class RemoteTypeImpl extends CommonExtensionBaseImpl implements RemoteType {
    ...
    protected EClass eStaticClass() {
        return BPMPackage.Literals.REMOTE_TYPE;
    }
    ...
    public NotificationChain basicSetExtraJaxbClasses(ExtraJaxbClassesType newExtraJaxbClasses, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMPackage.REMOTE_TYPE__EXTRA_JAXB_CLASSES, oldExtraJaxbClasses, newExtraJaxbClasses);
    ...
    public void setExtraJaxbClasses(ExtraJaxbClassesType newExtraJaxbClasses) {
        if (newExtraJaxbClasses != extraJaxbClasses) {
            ...
            if (extraJaxbClasses != null)
                msgs = ((InternalEObject)extraJaxbClasses).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMPackage.REMOTE_TYPE__EXTRA_JAXB_CLASSES, null, msgs);
            if (newExtraJaxbClasses != null)
                msgs = ((InternalEObject)newExtraJaxbClasses).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMPackage.REMOTE_TYPE__EXTRA_JAXB_CLASSES, null, msgs);
            msgs = basicSetExtraJaxbClasses(newExtraJaxbClasses, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BPMPackage.REMOTE_TYPE__EXTRA_JAXB_CLASSES, newExtraJaxbClasses, newExtraJaxbClasses));
    }
    ...
    public void setDeploymentId(String newDeploymentId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BPMPackage.REMOTE_TYPE__DEPLOYMENT_ID, oldDeploymentId, deploymentId));
    }
    ...
    public void setPassword(String newPassword) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BPMPackage.REMOTE_TYPE__PASSWORD, oldPassword, password));
    }
    ...
    public void setTimeout(Object newTimeout) {
        ...
        timeout = newTimeout;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BPMPackage.REMOTE_TYPE__TIMEOUT, oldTimeout, timeout));
    }
    ...
    public void setUserName(String newUserName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BPMPackage.REMOTE_TYPE__USER_NAME, oldUserName, userName));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case BPMPackage.REMOTE_TYPE__EXTRA_JAXB_CLASSES:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case BPMPackage.REMOTE_TYPE__DEPLOYMENT_ID:
                return getDeploymentId();
            case BPMPackage.REMOTE_TYPE__PASSWORD:
                return getPassword();
            case BPMPackage.REMOTE_TYPE__TIMEOUT:
                return getTimeout();
            case BPMPackage.REMOTE_TYPE__USER_NAME:
                return getUserName();
        }
