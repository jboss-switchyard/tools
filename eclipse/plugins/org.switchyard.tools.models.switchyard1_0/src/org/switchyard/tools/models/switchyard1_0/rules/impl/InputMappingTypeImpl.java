 ...
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.rules.impl.InputMappingTypeImpl#getOutput <em>Output</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InputMappingTypeImpl extends MappingTypeImpl implements InputMappingType {
    ...
    protected EClass eStaticClass() {
        return RulesPackage.Literals.INPUT_MAPPING_TYPE;
    }
    ...
    public void setOutput(String newOutput) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.INPUT_MAPPING_TYPE__OUTPUT, oldOutput, output));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case RulesPackage.INPUT_MAPPING_TYPE__OUTPUT:
                return getOutput();
        }
