...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>JPA Binding Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.impl.CamelJPABindingTypeImpl#getEntityClassName <em>Entity Class Name</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.impl.CamelJPABindingTypeImpl#getPersistenceUnit <em>Persistence Unit</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.impl.CamelJPABindingTypeImpl#getTransactionManager <em>Transaction Manager</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.impl.CamelJPABindingTypeImpl#getConsume <em>Consume</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.impl.CamelJPABindingTypeImpl#getProduce <em>Produce</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CamelJPABindingTypeImpl extends BaseCamelBindingImpl implements CamelJPABindingType {
	...
	protected EClass eStaticClass() {
        return CamelPackage.Literals.CAMEL_JPA_BINDING_TYPE;
    }
	...
	public void setEntityClassName(String newEntityClassName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.CAMEL_JPA_BINDING_TYPE__ENTITY_CLASS_NAME, oldEntityClassName, entityClassName));
    }
	...
	public void setPersistenceUnit(String newPersistenceUnit) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.CAMEL_JPA_BINDING_TYPE__PERSISTENCE_UNIT, oldPersistenceUnit, persistenceUnit));
    }
	...
	public void setTransactionManager(String newTransactionManager) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.CAMEL_JPA_BINDING_TYPE__TRANSACTION_MANAGER, oldTransactionManager, transactionManager));
    }
	...
	public NotificationChain basicSetConsume(JpaConsumerType newConsume, NotificationChain msgs) {
        ...
        consume = newConsume;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CamelPackage.CAMEL_JPA_BINDING_TYPE__CONSUME, oldConsume, newConsume);
	...
	public void setConsume(JpaConsumerType newConsume) {
        if (newConsume != consume) {
            ...
            if (consume != null)
                msgs = ((InternalEObject)consume).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CamelPackage.CAMEL_JPA_BINDING_TYPE__CONSUME, null, msgs);
            if (newConsume != null)
                msgs = ((InternalEObject)newConsume).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CamelPackage.CAMEL_JPA_BINDING_TYPE__CONSUME, null, msgs);
            msgs = basicSetConsume(newConsume, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.CAMEL_JPA_BINDING_TYPE__CONSUME, newConsume, newConsume));
    }
	...
	public NotificationChain basicSetProduce(JpaProducerType newProduce, NotificationChain msgs) {
        ...
        produce = newProduce;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CamelPackage.CAMEL_JPA_BINDING_TYPE__PRODUCE, oldProduce, newProduce);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
	...
	public void setProduce(JpaProducerType newProduce) {
        if (newProduce != produce) {
            NotificationChain msgs = null;
            if (produce != null)
                msgs = ((InternalEObject)produce).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CamelPackage.CAMEL_JPA_BINDING_TYPE__PRODUCE, null, msgs);
            if (newProduce != null)
                msgs = ((InternalEObject)newProduce).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CamelPackage.CAMEL_JPA_BINDING_TYPE__PRODUCE, null, msgs);
            msgs = basicSetProduce(newProduce, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.CAMEL_JPA_BINDING_TYPE__PRODUCE, newProduce, newProduce));
    }
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case CamelPackage.CAMEL_JPA_BINDING_TYPE__CONSUME:
                return basicSetConsume(null, msgs);
            case CamelPackage.CAMEL_JPA_BINDING_TYPE__PRODUCE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case CamelPackage.CAMEL_JPA_BINDING_TYPE__ENTITY_CLASS_NAME:
                return getEntityClassName();
            case CamelPackage.CAMEL_JPA_BINDING_TYPE__PERSISTENCE_UNIT:
                return getPersistenceUnit();
            case CamelPackage.CAMEL_JPA_BINDING_TYPE__TRANSACTION_MANAGER:
