...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Jpa Consumer Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.impl.JpaConsumerTypeImpl#getConsumeDelete <em>Consume Delete</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.impl.JpaConsumerTypeImpl#getConsumeLockEntity <em>Consume Lock Entity</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.impl.JpaConsumerTypeImpl#getMaximumResults <em>Maximum Results</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.impl.JpaConsumerTypeImpl#getConsumerQuery <em>Consumer Query</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.impl.JpaConsumerTypeImpl#getConsumerNamedQuery <em>Consumer Named Query</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.impl.JpaConsumerTypeImpl#getConsumerNativeQuery <em>Consumer Native Query</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.impl.JpaConsumerTypeImpl#getConsumerResultClass <em>Consumer Result Class</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.impl.JpaConsumerTypeImpl#getConsumerTransacted <em>Consumer Transacted</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JpaConsumerTypeImpl extends ScheduledBatchPollConsumerTypeImpl implements JpaConsumerType {
	...
	protected EClass eStaticClass() {
        return CamelPackage.Literals.JPA_CONSUMER_TYPE;
    }
	...
	public void setConsumeDelete(Boolean newConsumeDelete) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.JPA_CONSUMER_TYPE__CONSUME_DELETE, oldConsumeDelete, consumeDelete, !oldConsumeDeleteESet));
    }
	...
	public void unsetConsumeDelete() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, CamelPackage.JPA_CONSUMER_TYPE__CONSUME_DELETE, oldConsumeDelete, CONSUME_DELETE_EDEFAULT, oldConsumeDeleteESet));
    }
	...
	public void setConsumeLockEntity(Boolean newConsumeLockEntity) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.JPA_CONSUMER_TYPE__CONSUME_LOCK_ENTITY, oldConsumeLockEntity, consumeLockEntity, !oldConsumeLockEntityESet));
    }
	...
	public void unsetConsumeLockEntity() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, CamelPackage.JPA_CONSUMER_TYPE__CONSUME_LOCK_ENTITY, oldConsumeLockEntity, CONSUME_LOCK_ENTITY_EDEFAULT, oldConsumeLockEntityESet));
    }
	...
	public void setMaximumResults(Integer newMaximumResults) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.JPA_CONSUMER_TYPE__MAXIMUM_RESULTS, oldMaximumResults, maximumResults, !oldMaximumResultsESet));
    }
	...
	public void unsetMaximumResults() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, CamelPackage.JPA_CONSUMER_TYPE__MAXIMUM_RESULTS, oldMaximumResults, MAXIMUM_RESULTS_EDEFAULT, oldMaximumResultsESet));
    }
	...
	public void setConsumerQuery(String newConsumerQuery) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.JPA_CONSUMER_TYPE__CONSUMER_QUERY, oldConsumerQuery, consumerQuery));
    }
	...
	public void setConsumerNamedQuery(String newConsumerNamedQuery) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.JPA_CONSUMER_TYPE__CONSUMER_NAMED_QUERY, oldConsumerNamedQuery, consumerNamedQuery));
    }
	...
	public void setConsumerNativeQuery(String newConsumerNativeQuery) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.JPA_CONSUMER_TYPE__CONSUMER_NATIVE_QUERY, oldConsumerNativeQuery, consumerNativeQuery));
    }
	...
	public void setConsumerResultClass(String newConsumerResultClass) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.JPA_CONSUMER_TYPE__CONSUMER_RESULT_CLASS, oldConsumerResultClass, consumerResultClass));
    }
	...
	public void setConsumerTransacted(Boolean newConsumerTransacted) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.JPA_CONSUMER_TYPE__CONSUMER_TRANSACTED, oldConsumerTransacted, consumerTransacted, !oldConsumerTransactedESet));
    }
	...
	public void unsetConsumerTransacted() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, CamelPackage.JPA_CONSUMER_TYPE__CONSUMER_TRANSACTED, oldConsumerTransacted, CONSUMER_TRANSACTED_EDEFAULT, oldConsumerTransactedESet));
    }
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case CamelPackage.JPA_CONSUMER_TYPE__CONSUME_DELETE:
                return getConsumeDelete();
            case CamelPackage.JPA_CONSUMER_TYPE__CONSUME_LOCK_ENTITY:
                return getConsumeLockEntity();
            case CamelPackage.JPA_CONSUMER_TYPE__MAXIMUM_RESULTS:
                return getMaximumResults();
            case CamelPackage.JPA_CONSUMER_TYPE__CONSUMER_QUERY:
                return getConsumerQuery();
            case CamelPackage.JPA_CONSUMER_TYPE__CONSUMER_NAMED_QUERY:
                return getConsumerNamedQuery();
            case CamelPackage.JPA_CONSUMER_TYPE__CONSUMER_NATIVE_QUERY:
                return getConsumerNativeQuery();
            case CamelPackage.JPA_CONSUMER_TYPE__CONSUMER_RESULT_CLASS:
                return getConsumerResultClass();
            case CamelPackage.JPA_CONSUMER_TYPE__CONSUMER_TRANSACTED:
