 ...
 * <!-- end-user-doc -->
 * @see org.switchyard.tools.models.switchyard1_0.camel.rss.RssPackage
 * @generated
 */
public class RssSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case RssPackage.ADDITIONAL_URI_PARAMETERS_TYPE: {
            ...
            case RssPackage.BASE_CAMEL_BINDING: {
            ...
            case RssPackage.CAMEL_RSS_BINDING_TYPE: {
                CamelRSSBindingType camelRSSBindingType = (CamelRSSBindingType)theEObject;
                T result = caseCamelRSSBindingType(camelRSSBindingType);
                if (result == null) result = caseBaseCamelBinding(camelRSSBindingType);
                if (result == null) result = caseSwitchYardBindingType(camelRSSBindingType);
                if (result == null) result = caseBinding(camelRSSBindingType);
                if (result == null) result = caseCommonExtensionBase(camelRSSBindingType);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case RssPackage.DOCUMENT_ROOT: {
                DocumentRoot documentRoot = (DocumentRoot)theEObject;
                T result = caseDocumentRoot(documentRoot);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case RssPackage.PARAMETER_TYPE: {
                ParameterType parameterType = (ParameterType)theEObject;
                T result = caseParameterType(parameterType);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case RssPackage.RSS_SCHEDULED_POLL_CONSUMER_TYPE: {
                RSSScheduledPollConsumerType rssScheduledPollConsumerType = (RSSScheduledPollConsumerType)theEObject;
                T result = caseRSSScheduledPollConsumerType(rssScheduledPollConsumerType);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Camel RSS Binding Type</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Camel RSS Binding Type</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseCamelRSSBindingType(CamelRSSBindingType object) {
        return null;
    }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>RSS Scheduled Poll Consumer Type</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>RSS Scheduled Poll Consumer Type</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseRSSScheduledPollConsumerType(RSSScheduledPollConsumerType object) {
        return null;
    }
