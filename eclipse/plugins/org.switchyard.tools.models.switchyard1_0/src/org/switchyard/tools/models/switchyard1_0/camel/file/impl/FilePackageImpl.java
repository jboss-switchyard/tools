...
public class FilePackageImpl extends EPackageImpl implements FilePackage {
    ...
    public void initializePackageContents() {
        ...
        fileConsumerTypeEClass.getESuperTypes().add(theCamelPackage.getScheduledPollConsumerType());
        fileConsumerTypeEClass.getESuperTypes().add(theCamelPackage.getScheduledBatchPollConsumerType());
        fileConsumerTypeEClass.getESuperTypes().add(theCamelPackage.getGenericFileConsumerType());
        fileProducerTypeEClass.getESuperTypes().add(theCamelPackage.getGenericFileProducerType());
