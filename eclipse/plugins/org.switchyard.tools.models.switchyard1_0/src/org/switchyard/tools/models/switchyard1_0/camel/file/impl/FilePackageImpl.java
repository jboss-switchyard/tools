...
public class FilePackageImpl extends EPackageImpl implements FilePackage {
    ...
    public void initializePackageContents() {
        ...
        initEAttribute(getCamelFileBindingType_BufferSize(), theXMLTypePackage.getInt(), "bufferSize", "131072", 0, 1, CamelFileBindingType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getFileConsumerType_InitialDelay(), theXMLTypePackage.getInt(), "initialDelay", "1000", 0, 1, FileConsumerType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getFileConsumerType_Delay(), theXMLTypePackage.getInt(), "delay", "500", 0, 1, FileConsumerType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getFileConsumerType_MaxMessagesPerPoll(), theXMLTypePackage.getInt(), "maxMessagesPerPoll", null, 0, 1, FileConsumerType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getFileConsumerType_ReadLockTimeout(), theXMLTypePackage.getLong(), "readLockTimeout", "10000", 0, 1, FileConsumerType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getFileConsumerType_ReadLockCheckInterval(), theXMLTypePackage.getInt(), "readLockCheckInterval", "1000", 0, 1, FileConsumerType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
