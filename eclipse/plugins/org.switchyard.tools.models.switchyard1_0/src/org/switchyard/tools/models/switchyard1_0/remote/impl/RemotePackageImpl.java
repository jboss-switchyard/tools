 ...
 * @generated
 */
public class RemotePackageImpl extends EPackageImpl implements RemotePackage {
    /**
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    private EClass remoteBindingTypeEClass = null;
     ...
     * @see org.switchyard.tools.models.switchyard1_0.remote.RemotePackage#eNS_URI
     * @see #init()
     * @generated
     */
    private RemotePackageImpl() {
        super(eNS_URI, RemoteFactory.eINSTANCE);
    }
     ...
     * 
     * <p>This method is used to initialize {@link RemotePackage#eINSTANCE} when that field is accessed.
     ...
     * @generated
     */
    public static RemotePackage init() {
        if (isInited) return (RemotePackage)EPackage.Registry.INSTANCE.getEPackage(RemotePackage.eNS_URI);

        // Obtain or create and register package
        RemotePackageImpl theRemotePackage = (RemotePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof RemotePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new RemotePackageImpl());
        ...
        theRemotePackage.freeze();

  
        // Update the registry and return the package
        EPackage.Registry.INSTANCE.put(RemotePackage.eNS_URI, theRemotePackage);
        return theRemotePackage;
    }
     ...
     * @generated
     */
    public EClass getRemoteBindingType() {
        return remoteBindingTypeEClass;
    }
     ...
     * @generated
     */
    public EReference getDocumentRoot_RemoteBinding() {
    ...
    public RemoteFactory getRemoteFactory() {
        return (RemoteFactory)getEFactoryInstance();
    }
    ...
    public void createPackageContents() {
        ...
        remoteBindingTypeEClass = createEClass(REMOTE_BINDING_TYPE);

        documentRootEClass = createEClass(DOCUMENT_ROOT);
        createEAttribute(documentRootEClass, DOCUMENT_ROOT__MIXED);
        createEReference(documentRootEClass, DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
        createEReference(documentRootEClass, DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
        createEReference(documentRootEClass, DOCUMENT_ROOT__REMOTE_BINDING);
    }
    ...
    public void initializePackageContents() {
        ...
        remoteBindingTypeEClass.getESuperTypes().add(theScaPackage.getBinding());

        // Initialize classes and features; add operations and parameters
        initEClass(remoteBindingTypeEClass, RemoteBindingType.class, "RemoteBindingType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        ...
        initEReference(getDocumentRoot_RemoteBinding(), this.getRemoteBindingType(), null, "remoteBinding", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    ...
    protected void createExtendedMetaDataAnnotations() {
        ...
        addAnnotation
          (remoteBindingTypeEClass, 
           source, 
           new String[] {
             "name", "RemoteBindingType",
             "kind", "empty"
           });		
        addAnnotation
          (documentRootEClass, 
