 ...
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.rules.impl.RemoteJmsTypeImpl#getHostName <em>Host Name</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.rules.impl.RemoteJmsTypeImpl#getKeystoreLocation <em>Keystore Location</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.rules.impl.RemoteJmsTypeImpl#getKeystorePassword <em>Keystore Password</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.rules.impl.RemoteJmsTypeImpl#getRemotingPort <em>Remoting Port</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.rules.impl.RemoteJmsTypeImpl#getMessagingPort <em>Messaging Port</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.rules.impl.RemoteJmsTypeImpl#getTruststoreLocation <em>Truststore Location</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.rules.impl.RemoteJmsTypeImpl#getTruststorePassword <em>Truststore Password</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.rules.impl.RemoteJmsTypeImpl#getUseSsl <em>Use Ssl</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RemoteJmsTypeImpl extends RemoteTypeImpl implements RemoteJmsType {
    ...
    protected EClass eStaticClass() {
        return RulesPackage.Literals.REMOTE_JMS_TYPE;
    }
    ...
    public void setHostName(String newHostName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.REMOTE_JMS_TYPE__HOST_NAME, oldHostName, hostName));
    }
    ...
    public void setKeystoreLocation(String newKeystoreLocation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.REMOTE_JMS_TYPE__KEYSTORE_LOCATION, oldKeystoreLocation, keystoreLocation));
    }
    ...
    public void setKeystorePassword(String newKeystorePassword) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.REMOTE_JMS_TYPE__KEYSTORE_PASSWORD, oldKeystorePassword, keystorePassword));
    }
    ...
    public void setRemotingPort(Object newRemotingPort) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.REMOTE_JMS_TYPE__REMOTING_PORT, oldRemotingPort, remotingPort));
    }
    ...
    public void setMessagingPort(Object newMessagingPort) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.REMOTE_JMS_TYPE__MESSAGING_PORT, oldMessagingPort, messagingPort));
    }
    ...
    public void setTruststoreLocation(String newTruststoreLocation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.REMOTE_JMS_TYPE__TRUSTSTORE_LOCATION, oldTruststoreLocation, truststoreLocation));
    }
    ...
    public void setTruststorePassword(String newTruststorePassword) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.REMOTE_JMS_TYPE__TRUSTSTORE_PASSWORD, oldTruststorePassword, truststorePassword));
    }
    ...
    public void setUseSsl(Object newUseSsl) {
        ...
        useSsl = newUseSsl;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.REMOTE_JMS_TYPE__USE_SSL, oldUseSsl, useSsl));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case RulesPackage.REMOTE_JMS_TYPE__HOST_NAME:
                return getHostName();
            case RulesPackage.REMOTE_JMS_TYPE__KEYSTORE_LOCATION:
                return getKeystoreLocation();
            case RulesPackage.REMOTE_JMS_TYPE__KEYSTORE_PASSWORD:
                return getKeystorePassword();
            case RulesPackage.REMOTE_JMS_TYPE__REMOTING_PORT:
                return getRemotingPort();
            case RulesPackage.REMOTE_JMS_TYPE__MESSAGING_PORT:
                return getMessagingPort();
            case RulesPackage.REMOTE_JMS_TYPE__TRUSTSTORE_LOCATION:
                return getTruststoreLocation();
            case RulesPackage.REMOTE_JMS_TYPE__TRUSTSTORE_PASSWORD:
                return getTruststorePassword();
            case RulesPackage.REMOTE_JMS_TYPE__USE_SSL:
                return getUseSsl();
        }
