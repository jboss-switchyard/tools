...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Camel Sap QI Doc List Destination Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.sap.impl.CamelSapQIDocListDestinationTypeImpl#getDestinationName <em>Destination Name</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.sap.impl.CamelSapQIDocListDestinationTypeImpl#getQueueName <em>Queue Name</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.sap.impl.CamelSapQIDocListDestinationTypeImpl#getIdocType <em>Idoc Type</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.sap.impl.CamelSapQIDocListDestinationTypeImpl#getIdocTypeExtension <em>Idoc Type Extension</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.sap.impl.CamelSapQIDocListDestinationTypeImpl#getSystemRelease <em>System Release</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.sap.impl.CamelSapQIDocListDestinationTypeImpl#getApplicationRelease <em>Application Release</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CamelSapQIDocListDestinationTypeImpl extends EObjectImpl implements CamelSapQIDocListDestinationType {
    /**
     ...
     * @generated
     */
    protected CamelSapQIDocListDestinationTypeImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return SapPackage.Literals.CAMEL_SAP_QI_DOC_LIST_DESTINATION_TYPE;
    }
    ...
    public void setDestinationName(String newDestinationName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SapPackage.CAMEL_SAP_QI_DOC_LIST_DESTINATION_TYPE__DESTINATION_NAME, oldDestinationName, destinationName));
    }
    ...
    public void setQueueName(String newQueueName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SapPackage.CAMEL_SAP_QI_DOC_LIST_DESTINATION_TYPE__QUEUE_NAME, oldQueueName, queueName));
    }
    ...
    public void setIdocType(String newIdocType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SapPackage.CAMEL_SAP_QI_DOC_LIST_DESTINATION_TYPE__IDOC_TYPE, oldIdocType, idocType));
    }
    ...
    public void setIdocTypeExtension(String newIdocTypeExtension) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SapPackage.CAMEL_SAP_QI_DOC_LIST_DESTINATION_TYPE__IDOC_TYPE_EXTENSION, oldIdocTypeExtension, idocTypeExtension));
    }
    ...
    public void setSystemRelease(String newSystemRelease) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SapPackage.CAMEL_SAP_QI_DOC_LIST_DESTINATION_TYPE__SYSTEM_RELEASE, oldSystemRelease, systemRelease));
    }
    ...
    public void setApplicationRelease(String newApplicationRelease) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SapPackage.CAMEL_SAP_QI_DOC_LIST_DESTINATION_TYPE__APPLICATION_RELEASE, oldApplicationRelease, applicationRelease));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case SapPackage.CAMEL_SAP_QI_DOC_LIST_DESTINATION_TYPE__DESTINATION_NAME:
                return getDestinationName();
            case SapPackage.CAMEL_SAP_QI_DOC_LIST_DESTINATION_TYPE__QUEUE_NAME:
                return getQueueName();
            case SapPackage.CAMEL_SAP_QI_DOC_LIST_DESTINATION_TYPE__IDOC_TYPE:
                return getIdocType();
            case SapPackage.CAMEL_SAP_QI_DOC_LIST_DESTINATION_TYPE__IDOC_TYPE_EXTENSION:
                return getIdocTypeExtension();
            case SapPackage.CAMEL_SAP_QI_DOC_LIST_DESTINATION_TYPE__SYSTEM_RELEASE:
                return getSystemRelease();
            case SapPackage.CAMEL_SAP_QI_DOC_LIST_DESTINATION_TYPE__APPLICATION_RELEASE:
...
} //CamelSapQIDocListDestinationTypeImpl
