...
public class JmsPackageImpl extends EPackageImpl implements JmsPackage {
    ...
    public void initializePackageContents() {
        ...
        initEAttribute(getCamelJmsBindingType_ConcurrentConsumers(), theXMLTypePackage.getInt(), "concurrentConsumers", "1", 0, 1, CamelJmsBindingType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getCamelJmsBindingType_MaxConcurrentConsumers(), theXMLTypePackage.getInt(), "maxConcurrentConsumers", "1", 0, 1, CamelJmsBindingType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getCamelJmsBindingType_Priority(), theXMLTypePackage.getInt(), "priority", "4", 0, 1, CamelJmsBindingType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getCamelJmsBindingType_RequestTimeout(), theXMLTypePackage.getInt(), "requestTimeout", "20000", 0, 1, CamelJmsBindingType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
