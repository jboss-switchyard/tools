 ...
 * @generated
 */
public class CommonselectorSwitch<T> extends Switch<T> {
    /**
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case CommonselectorPackage.DOCUMENT_ROOT: {
                DocumentRoot documentRoot = (DocumentRoot)theEObject;
                T result = caseDocumentRoot(documentRoot);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case CommonselectorPackage.STATIC_OPERATION_SELECTOR_TYPE: {
            ...
            case CommonselectorPackage.XPATH_OPERATION_SELECTOR_TYPE: {
            ...
            case CommonselectorPackage.REGEX_OPERATION_SELECTOR_TYPE: {
            ...
            case CommonselectorPackage.JAVA_OPERATION_SELECTOR_TYPE: {
