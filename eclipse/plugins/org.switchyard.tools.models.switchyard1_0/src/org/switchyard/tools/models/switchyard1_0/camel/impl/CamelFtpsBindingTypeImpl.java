...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Ftps Binding Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.impl.CamelFtpsBindingTypeImpl#getSecurityProtocol <em>Security Protocol</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.impl.CamelFtpsBindingTypeImpl#isIsImplicit <em>Is Implicit</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.impl.CamelFtpsBindingTypeImpl#getExecPbsz <em>Exec Pbsz</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.impl.CamelFtpsBindingTypeImpl#getExecProt <em>Exec Prot</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.impl.CamelFtpsBindingTypeImpl#isDisableSecureDataChannelDefaults <em>Disable Secure Data Channel Defaults</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CamelFtpsBindingTypeImpl extends CamelFtpBindingTypeImpl implements CamelFtpsBindingType {
    ...
    protected EClass eStaticClass() {
        return CamelPackage.Literals.CAMEL_FTPS_BINDING_TYPE;
    }
    ...
    public void setSecurityProtocol(String newSecurityProtocol) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.CAMEL_FTPS_BINDING_TYPE__SECURITY_PROTOCOL, oldSecurityProtocol, securityProtocol));
    }
    ...
    public void setIsImplicit(boolean newIsImplicit) {
        ...
        isImplicitESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.CAMEL_FTPS_BINDING_TYPE__IS_IMPLICIT, oldIsImplicit, isImplicit, !oldIsImplicitESet));
    }
    ...
    public void unsetIsImplicit() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, CamelPackage.CAMEL_FTPS_BINDING_TYPE__IS_IMPLICIT, oldIsImplicit, IS_IMPLICIT_EDEFAULT, oldIsImplicitESet));
    }
    ...
    public void setExecPbsz(long newExecPbsz) {
        ...
        execPbszESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.CAMEL_FTPS_BINDING_TYPE__EXEC_PBSZ, oldExecPbsz, execPbsz, !oldExecPbszESet));
    }
    ...
    public void unsetExecPbsz() {
        ...
        execPbszESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, CamelPackage.CAMEL_FTPS_BINDING_TYPE__EXEC_PBSZ, oldExecPbsz, EXEC_PBSZ_EDEFAULT, oldExecPbszESet));
    }
    ...
    public void setExecProt(String newExecProt) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.CAMEL_FTPS_BINDING_TYPE__EXEC_PROT, oldExecProt, execProt));
    }
    ...
    public void setDisableSecureDataChannelDefaults(boolean newDisableSecureDataChannelDefaults) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.CAMEL_FTPS_BINDING_TYPE__DISABLE_SECURE_DATA_CHANNEL_DEFAULTS, oldDisableSecureDataChannelDefaults, disableSecureDataChannelDefaults, !oldDisableSecureDataChannelDefaultsESet));
    }
    ...
    public void unsetDisableSecureDataChannelDefaults() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, CamelPackage.CAMEL_FTPS_BINDING_TYPE__DISABLE_SECURE_DATA_CHANNEL_DEFAULTS, oldDisableSecureDataChannelDefaults, DISABLE_SECURE_DATA_CHANNEL_DEFAULTS_EDEFAULT, oldDisableSecureDataChannelDefaultsESet));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case CamelPackage.CAMEL_FTPS_BINDING_TYPE__SECURITY_PROTOCOL:
                return getSecurityProtocol();
            case CamelPackage.CAMEL_FTPS_BINDING_TYPE__IS_IMPLICIT:
                return isIsImplicit();
            case CamelPackage.CAMEL_FTPS_BINDING_TYPE__EXEC_PBSZ:
                return getExecPbsz();
            case CamelPackage.CAMEL_FTPS_BINDING_TYPE__EXEC_PROT:
                return getExecProt();
            case CamelPackage.CAMEL_FTPS_BINDING_TYPE__DISABLE_SECURE_DATA_CHANNEL_DEFAULTS:
