...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Generic File Producer Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.core.impl.GenericFileProducerTypeImpl#getFileExist <em>File Exist</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.core.impl.GenericFileProducerTypeImpl#getTempPrefix <em>Temp Prefix</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.core.impl.GenericFileProducerTypeImpl#getTempFileName <em>Temp File Name</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.core.impl.GenericFileProducerTypeImpl#getKeepLastModified <em>Keep Last Modified</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.core.impl.GenericFileProducerTypeImpl#getEagerDeleteTargetFile <em>Eager Delete Target File</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.core.impl.GenericFileProducerTypeImpl#getDoneFileName <em>Done File Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GenericFileProducerTypeImpl extends EObjectImpl implements GenericFileProducerType {
    /**
     ...
     * @generated
     */
    protected GenericFileProducerTypeImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return CamelPackage.Literals.GENERIC_FILE_PRODUCER_TYPE;
    }
    ...
    public void setFileExist(String newFileExist) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.GENERIC_FILE_PRODUCER_TYPE__FILE_EXIST, oldFileExist, fileExist));
    }
    ...
    public void setTempPrefix(String newTempPrefix) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.GENERIC_FILE_PRODUCER_TYPE__TEMP_PREFIX, oldTempPrefix, tempPrefix));
    }
    ...
    public void setTempFileName(String newTempFileName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.GENERIC_FILE_PRODUCER_TYPE__TEMP_FILE_NAME, oldTempFileName, tempFileName));
    }
    ...
    public void setKeepLastModified(Boolean newKeepLastModified) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.GENERIC_FILE_PRODUCER_TYPE__KEEP_LAST_MODIFIED, oldKeepLastModified, keepLastModified, !oldKeepLastModifiedESet));
    }
    ...
    public void unsetKeepLastModified() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, CamelPackage.GENERIC_FILE_PRODUCER_TYPE__KEEP_LAST_MODIFIED, oldKeepLastModified, KEEP_LAST_MODIFIED_EDEFAULT, oldKeepLastModifiedESet));
    }
    ...
    public void setEagerDeleteTargetFile(Boolean newEagerDeleteTargetFile) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.GENERIC_FILE_PRODUCER_TYPE__EAGER_DELETE_TARGET_FILE, oldEagerDeleteTargetFile, eagerDeleteTargetFile, !oldEagerDeleteTargetFileESet));
    }
    ...
    public void unsetEagerDeleteTargetFile() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, CamelPackage.GENERIC_FILE_PRODUCER_TYPE__EAGER_DELETE_TARGET_FILE, oldEagerDeleteTargetFile, EAGER_DELETE_TARGET_FILE_EDEFAULT, oldEagerDeleteTargetFileESet));
    }
    ...
    public void setDoneFileName(String newDoneFileName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.GENERIC_FILE_PRODUCER_TYPE__DONE_FILE_NAME, oldDoneFileName, doneFileName));
    }
