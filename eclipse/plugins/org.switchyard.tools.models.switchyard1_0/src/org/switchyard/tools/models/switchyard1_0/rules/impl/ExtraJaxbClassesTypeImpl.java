 ...
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.rules.impl.ExtraJaxbClassesTypeImpl#getExtraJaxbClass <em>Extra Jaxb Class</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExtraJaxbClassesTypeImpl extends CommonExtensionBaseImpl implements ExtraJaxbClassesType {
    ...
    protected EClass eStaticClass() {
        return RulesPackage.Literals.EXTRA_JAXB_CLASSES_TYPE;
    }
    ...
    public EList<String> getExtraJaxbClass() {
        if (extraJaxbClass == null) {
            extraJaxbClass = new EDataTypeEList<String>(String.class, this, RulesPackage.EXTRA_JAXB_CLASSES_TYPE__EXTRA_JAXB_CLASS);
        }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case RulesPackage.EXTRA_JAXB_CLASSES_TYPE__EXTRA_JAXB_CLASS:
