 ...
 * @generated
 */
public class MqttSwitch<T> extends Switch<T> {
    /**
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case MqttPackage.ADDITIONAL_URI_PARAMETERS_TYPE: {
            ...
            case MqttPackage.BASE_CAMEL_BINDING: {
            ...
            case MqttPackage.CAMEL_MQTT_BINDING_TYPE: {
                CamelMqttBindingType camelMqttBindingType = (CamelMqttBindingType)theEObject;
                T result = caseCamelMqttBindingType(camelMqttBindingType);
                if (result == null) result = caseBaseCamelBinding(camelMqttBindingType);
                if (result == null) result = caseSwitchYardBindingType(camelMqttBindingType);
                if (result == null) result = caseBinding(camelMqttBindingType);
                if (result == null) result = caseCommonExtensionBase(camelMqttBindingType);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case MqttPackage.DOCUMENT_ROOT: {
                DocumentRoot documentRoot = (DocumentRoot)theEObject;
                T result = caseDocumentRoot(documentRoot);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case MqttPackage.PARAMETER_TYPE: {
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Camel Mqtt Binding Type</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Camel Mqtt Binding Type</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseCamelMqttBindingType(CamelMqttBindingType object) {
        return null;
    }
