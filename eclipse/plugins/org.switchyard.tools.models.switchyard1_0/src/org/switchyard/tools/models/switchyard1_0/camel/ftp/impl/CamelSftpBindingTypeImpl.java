...
public class CamelSftpBindingTypeImpl extends CamelRemoteBindingTypeImpl implements CamelSftpBindingType {
    ...
    public RemoteFileConsumerType getConsume() {
        if (consume != null && consume.eIsProxy()) {
            ...
            if (consume != oldConsume) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, FtpPackage.CAMEL_SFTP_BINDING_TYPE__CONSUME, oldConsume, consume));
            }
        }
        return consume;
    }
    ...
    public void setConsume(RemoteFileConsumerType newConsume) {
        ...
        consume = newConsume;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FtpPackage.CAMEL_SFTP_BINDING_TYPE__CONSUME, oldConsume, consume));
    }
    ...
    public RemoteFileProducerType getProduce() {
        if (produce != null && produce.eIsProxy()) {
            ...
            if (produce != oldProduce) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, FtpPackage.CAMEL_SFTP_BINDING_TYPE__PRODUCE, oldProduce, produce));
            }
        }
        return produce;
    }
    ...
    public void setProduce(RemoteFileProducerType newProduce) {
        ...
        produce = newProduce;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FtpPackage.CAMEL_SFTP_BINDING_TYPE__PRODUCE, oldProduce, produce));
    }
