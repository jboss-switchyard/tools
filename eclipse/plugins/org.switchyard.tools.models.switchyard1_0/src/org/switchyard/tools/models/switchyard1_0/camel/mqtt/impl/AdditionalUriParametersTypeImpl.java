 ...
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.mqtt.impl.AdditionalUriParametersTypeImpl#getParameter <em>Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AdditionalUriParametersTypeImpl extends EObjectImpl implements AdditionalUriParametersType {
    ...
    protected EClass eStaticClass() {
        return MqttPackage.Literals.ADDITIONAL_URI_PARAMETERS_TYPE;
    }
    ...
    public EList<ParameterType> getParameter() {
        if (parameter == null) {
            parameter = new EObjectContainmentEList<ParameterType>(ParameterType.class, this, MqttPackage.ADDITIONAL_URI_PARAMETERS_TYPE__PARAMETER);
        }
        return parameter;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case MqttPackage.ADDITIONAL_URI_PARAMETERS_TYPE__PARAMETER:
