 ...
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.impl.CamelBindingTypeImpl#getConfigURI <em>Config URI</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CamelBindingTypeImpl extends BaseCamelBindingImpl implements CamelBindingType {
    ...
    public void setConfigURI(String newConfigURI) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.CAMEL_BINDING_TYPE__CONFIG_URI, oldConfigURI, configURI));
    }
    ...
    public EStructuralFeature getDocumentFeature() {
        return CamelPackage.eINSTANCE.getDocumentRoot_BindingCamel();
    }
