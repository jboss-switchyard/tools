...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Camel Sap QRfc Destination Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.sap.impl.CamelSapQRfcDestinationTypeImpl#getDestinationName <em>Destination Name</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.sap.impl.CamelSapQRfcDestinationTypeImpl#getQueueName <em>Queue Name</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.sap.impl.CamelSapQRfcDestinationTypeImpl#getRfcName <em>Rfc Name</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.sap.impl.CamelSapQRfcDestinationTypeImpl#getTransacted <em>Transacted</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CamelSapQRfcDestinationTypeImpl extends EObjectImpl implements CamelSapQRfcDestinationType {
    /**
     ...
     * @generated
     */
    protected CamelSapQRfcDestinationTypeImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return SapPackage.Literals.CAMEL_SAP_QRFC_DESTINATION_TYPE;
    }
    ...
    public void setDestinationName(String newDestinationName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SapPackage.CAMEL_SAP_QRFC_DESTINATION_TYPE__DESTINATION_NAME, oldDestinationName, destinationName));
    }
    ...
    public void setQueueName(String newQueueName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SapPackage.CAMEL_SAP_QRFC_DESTINATION_TYPE__QUEUE_NAME, oldQueueName, queueName));
    }
    ...
    public void setRfcName(String newRfcName) {
        ...
        rfcName = newRfcName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SapPackage.CAMEL_SAP_QRFC_DESTINATION_TYPE__RFC_NAME, oldRfcName, rfcName));
    }
    ...
    public void setTransacted(Object newTransacted) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SapPackage.CAMEL_SAP_QRFC_DESTINATION_TYPE__TRANSACTED, oldTransacted, transacted));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case SapPackage.CAMEL_SAP_QRFC_DESTINATION_TYPE__DESTINATION_NAME:
                return getDestinationName();
            case SapPackage.CAMEL_SAP_QRFC_DESTINATION_TYPE__QUEUE_NAME:
                return getQueueName();
            case SapPackage.CAMEL_SAP_QRFC_DESTINATION_TYPE__RFC_NAME:
                return getRfcName();
            case SapPackage.CAMEL_SAP_QRFC_DESTINATION_TYPE__TRANSACTED:
...
} //CamelSapQRfcDestinationTypeImpl
