 ...
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.bpm.impl.ManifestTypeImpl#getRemoteJms <em>Remote Jms</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.bpm.impl.ManifestTypeImpl#getRemoteRest <em>Remote Rest</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ManifestTypeImpl extends CommonExtensionBaseImpl implements ManifestType {
    ...
    public NotificationChain basicSetRemoteJms(RemoteJmsType newRemoteJms, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMPackage.MANIFEST_TYPE__REMOTE_JMS, oldRemoteJms, newRemoteJms);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setRemoteJms(RemoteJmsType newRemoteJms) {
        if (newRemoteJms != remoteJms) {
            NotificationChain msgs = null;
            if (remoteJms != null)
                msgs = ((InternalEObject)remoteJms).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMPackage.MANIFEST_TYPE__REMOTE_JMS, null, msgs);
            if (newRemoteJms != null)
                msgs = ((InternalEObject)newRemoteJms).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMPackage.MANIFEST_TYPE__REMOTE_JMS, null, msgs);
            msgs = basicSetRemoteJms(newRemoteJms, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BPMPackage.MANIFEST_TYPE__REMOTE_JMS, newRemoteJms, newRemoteJms));
    }
    ...
    public NotificationChain basicSetRemoteRest(RemoteRestType newRemoteRest, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMPackage.MANIFEST_TYPE__REMOTE_REST, oldRemoteRest, newRemoteRest);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setRemoteRest(RemoteRestType newRemoteRest) {
        if (newRemoteRest != remoteRest) {
            NotificationChain msgs = null;
            if (remoteRest != null)
                msgs = ((InternalEObject)remoteRest).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMPackage.MANIFEST_TYPE__REMOTE_REST, null, msgs);
            if (newRemoteRest != null)
                msgs = ((InternalEObject)newRemoteRest).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMPackage.MANIFEST_TYPE__REMOTE_REST, null, msgs);
            msgs = basicSetRemoteRest(newRemoteRest, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BPMPackage.MANIFEST_TYPE__REMOTE_REST, newRemoteRest, newRemoteRest));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case BPMPackage.MANIFEST_TYPE__REMOTE_JMS:
                return basicSetRemoteJms(null, msgs);
            case BPMPackage.MANIFEST_TYPE__REMOTE_REST:
