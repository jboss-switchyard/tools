 ...
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.rules.impl.PropertiesTypeImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.rules.impl.PropertiesTypeImpl#getLoad <em>Load</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PropertiesTypeImpl extends CommonExtensionBaseImpl implements PropertiesType {
    ...
    public void setLoad(String newLoad) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.PROPERTIES_TYPE__LOAD, oldLoad, load));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case RulesPackage.PROPERTIES_TYPE__PROPERTY:
                return getProperty();
            case RulesPackage.PROPERTIES_TYPE__LOAD:
                return getLoad();
        }
