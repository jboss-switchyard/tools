 ...
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.rules.impl.GlobalsTypeImpl#getMapping <em>Mapping</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GlobalsTypeImpl extends CommonExtensionBaseImpl implements GlobalsType {
    ...
    public EList<MappingType> getMapping() {
        if (mapping == null) {
            mapping = new EObjectContainmentEList<MappingType>(MappingType.class, this, RulesPackage.GLOBALS_TYPE__MAPPING);
        }
        return mapping;
    }
