 ...
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.rss.impl.BaseCamelBindingImpl#getContextMapper <em>Context Mapper</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.rss.impl.BaseCamelBindingImpl#getMessageComposer <em>Message Composer</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.rss.impl.BaseCamelBindingImpl#getAdditionalUriParameters <em>Additional Uri Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BaseCamelBindingImpl extends SwitchYardBindingTypeImpl implements BaseCamelBinding {
    ...
    protected EClass eStaticClass() {
        return RssPackage.Literals.BASE_CAMEL_BINDING;
    }
    ...
    public NotificationChain basicSetContextMapper(ContextMapperType newContextMapper, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RssPackage.BASE_CAMEL_BINDING__CONTEXT_MAPPER, oldContextMapper, newContextMapper);
    ...
    public void setContextMapper(ContextMapperType newContextMapper) {
        if (newContextMapper != contextMapper) {
            ...
            if (contextMapper != null)
                msgs = ((InternalEObject)contextMapper).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RssPackage.BASE_CAMEL_BINDING__CONTEXT_MAPPER, null, msgs);
            if (newContextMapper != null)
                msgs = ((InternalEObject)newContextMapper).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RssPackage.BASE_CAMEL_BINDING__CONTEXT_MAPPER, null, msgs);
            msgs = basicSetContextMapper(newContextMapper, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RssPackage.BASE_CAMEL_BINDING__CONTEXT_MAPPER, newContextMapper, newContextMapper));
    }
    ...
    public NotificationChain basicSetMessageComposer(MessageComposerType newMessageComposer, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RssPackage.BASE_CAMEL_BINDING__MESSAGE_COMPOSER, oldMessageComposer, newMessageComposer);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setMessageComposer(MessageComposerType newMessageComposer) {
        if (newMessageComposer != messageComposer) {
            ...
            if (messageComposer != null)
                msgs = ((InternalEObject)messageComposer).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RssPackage.BASE_CAMEL_BINDING__MESSAGE_COMPOSER, null, msgs);
            if (newMessageComposer != null)
                msgs = ((InternalEObject)newMessageComposer).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RssPackage.BASE_CAMEL_BINDING__MESSAGE_COMPOSER, null, msgs);
            msgs = basicSetMessageComposer(newMessageComposer, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RssPackage.BASE_CAMEL_BINDING__MESSAGE_COMPOSER, newMessageComposer, newMessageComposer));
    }
    ...
    public NotificationChain basicSetAdditionalUriParameters(AdditionalUriParametersType newAdditionalUriParameters, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RssPackage.BASE_CAMEL_BINDING__ADDITIONAL_URI_PARAMETERS, oldAdditionalUriParameters, newAdditionalUriParameters);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setAdditionalUriParameters(AdditionalUriParametersType newAdditionalUriParameters) {
        if (newAdditionalUriParameters != additionalUriParameters) {
            ...
            if (additionalUriParameters != null)
                msgs = ((InternalEObject)additionalUriParameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RssPackage.BASE_CAMEL_BINDING__ADDITIONAL_URI_PARAMETERS, null, msgs);
            if (newAdditionalUriParameters != null)
                msgs = ((InternalEObject)newAdditionalUriParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RssPackage.BASE_CAMEL_BINDING__ADDITIONAL_URI_PARAMETERS, null, msgs);
            msgs = basicSetAdditionalUriParameters(newAdditionalUriParameters, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RssPackage.BASE_CAMEL_BINDING__ADDITIONAL_URI_PARAMETERS, newAdditionalUriParameters, newAdditionalUriParameters));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case RssPackage.BASE_CAMEL_BINDING__CONTEXT_MAPPER:
                return basicSetContextMapper(null, msgs);
            case RssPackage.BASE_CAMEL_BINDING__MESSAGE_COMPOSER:
                return basicSetMessageComposer(null, msgs);
            case RssPackage.BASE_CAMEL_BINDING__ADDITIONAL_URI_PARAMETERS:
