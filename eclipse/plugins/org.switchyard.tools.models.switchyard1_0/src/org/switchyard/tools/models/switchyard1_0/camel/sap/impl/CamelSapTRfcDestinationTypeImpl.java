...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Camel Sap TRfc Destination Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.sap.impl.CamelSapTRfcDestinationTypeImpl#getDestinationName <em>Destination Name</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.sap.impl.CamelSapTRfcDestinationTypeImpl#getRfcName <em>Rfc Name</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.sap.impl.CamelSapTRfcDestinationTypeImpl#getTransacted <em>Transacted</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CamelSapTRfcDestinationTypeImpl extends EObjectImpl implements CamelSapTRfcDestinationType {
    /**
     ...
     * @generated
     */
    protected CamelSapTRfcDestinationTypeImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return SapPackage.Literals.CAMEL_SAP_TRFC_DESTINATION_TYPE;
    }
    ...
    public void setDestinationName(String newDestinationName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SapPackage.CAMEL_SAP_TRFC_DESTINATION_TYPE__DESTINATION_NAME, oldDestinationName, destinationName));
    }
    ...
    public void setRfcName(String newRfcName) {
        ...
        rfcName = newRfcName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SapPackage.CAMEL_SAP_TRFC_DESTINATION_TYPE__RFC_NAME, oldRfcName, rfcName));
    }
    ...
    public void setTransacted(Object newTransacted) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SapPackage.CAMEL_SAP_TRFC_DESTINATION_TYPE__TRANSACTED, oldTransacted, transacted));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case SapPackage.CAMEL_SAP_TRFC_DESTINATION_TYPE__DESTINATION_NAME:
                return getDestinationName();
            case SapPackage.CAMEL_SAP_TRFC_DESTINATION_TYPE__RFC_NAME:
                return getRfcName();
            case SapPackage.CAMEL_SAP_TRFC_DESTINATION_TYPE__TRANSACTED:
...
} //CamelSapTRfcDestinationTypeImpl
