...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Camel Sap SRfc Server Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.sap.impl.CamelSapSRfcServerTypeImpl#getServerName <em>Server Name</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.sap.impl.CamelSapSRfcServerTypeImpl#getRfcName <em>Rfc Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CamelSapSRfcServerTypeImpl extends EObjectImpl implements CamelSapSRfcServerType {
    /**
     ...
     * @generated
     */
    protected CamelSapSRfcServerTypeImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return SapPackage.Literals.CAMEL_SAP_SRFC_SERVER_TYPE;
    }
    ...
    public void setServerName(String newServerName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SapPackage.CAMEL_SAP_SRFC_SERVER_TYPE__SERVER_NAME, oldServerName, serverName));
    }
    ...
    public void setRfcName(String newRfcName) {
        ...
        rfcName = newRfcName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SapPackage.CAMEL_SAP_SRFC_SERVER_TYPE__RFC_NAME, oldRfcName, rfcName));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case SapPackage.CAMEL_SAP_SRFC_SERVER_TYPE__SERVER_NAME:
                return getServerName();
            case SapPackage.CAMEL_SAP_SRFC_SERVER_TYPE__RFC_NAME:
                return getRfcName();
        }
