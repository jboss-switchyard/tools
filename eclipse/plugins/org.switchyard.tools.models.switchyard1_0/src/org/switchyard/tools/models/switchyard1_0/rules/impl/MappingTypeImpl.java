 ...
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.rules.impl.MappingTypeImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.rules.impl.MappingTypeImpl#getExpressionType <em>Expression Type</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.rules.impl.MappingTypeImpl#getScope <em>Scope</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.rules.impl.MappingTypeImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MappingTypeImpl extends CommonExtensionBaseImpl implements MappingType {
    ...
    public void setExpression(String newExpression) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.MAPPING_TYPE__EXPRESSION, oldExpression, expression));
    }
    ...
    public void setExpressionType(ExpressionType newExpressionType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.MAPPING_TYPE__EXPRESSION_TYPE, oldExpressionType, expressionType, !oldExpressionTypeESet));
    }
    ...
    public void unsetExpressionType() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, RulesPackage.MAPPING_TYPE__EXPRESSION_TYPE, oldExpressionType, EXPRESSION_TYPE_EDEFAULT, oldExpressionTypeESet));
    }
    ...
    public void setScope(ScopeType newScope) {
        ...
        scopeESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.MAPPING_TYPE__SCOPE, oldScope, scope, !oldScopeESet));
    }
    ...
    public void unsetScope() {
        ...
        scopeESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, RulesPackage.MAPPING_TYPE__SCOPE, oldScope, SCOPE_EDEFAULT, oldScopeESet));
    }
    ...
    public void setVariable(String newVariable) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.MAPPING_TYPE__VARIABLE, oldVariable, variable));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case RulesPackage.MAPPING_TYPE__EXPRESSION:
                return getExpression();
            case RulesPackage.MAPPING_TYPE__EXPRESSION_TYPE:
                return getExpressionType();
            case RulesPackage.MAPPING_TYPE__SCOPE:
                return getScope();
            case RulesPackage.MAPPING_TYPE__VARIABLE:
                return getVariable();
        }
