...
public class ActionType1Impl extends CommonExtensionBaseImpl implements ActionType1 {
    ...
    public void setGlobals(MappingsType newGlobals) {
        if (newGlobals != globals) {
            ...
            if (globals != null)
                msgs = ((InternalEObject)globals).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RulesPackage.ACTION_TYPE1__GLOBALS, null, msgs);
            if (newGlobals != null)
                msgs = ((InternalEObject)newGlobals).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RulesPackage.ACTION_TYPE1__GLOBALS, null, msgs);
            msgs = basicSetGlobals(newGlobals, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.ACTION_TYPE1__GLOBALS, newGlobals, newGlobals));
    }
    ...
    public void setInputs(MappingsType newInputs) {
        if (newInputs != inputs) {
            NotificationChain msgs = null;
            if (inputs != null)
                msgs = ((InternalEObject)inputs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RulesPackage.ACTION_TYPE1__INPUTS, null, msgs);
            if (newInputs != null)
                msgs = ((InternalEObject)newInputs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RulesPackage.ACTION_TYPE1__INPUTS, null, msgs);
            msgs = basicSetInputs(newInputs, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.ACTION_TYPE1__INPUTS, newInputs, newInputs));
    }
    ...
    public void setOutputs(MappingsType newOutputs) {
        if (newOutputs != outputs) {
            NotificationChain msgs = null;
            if (outputs != null)
                msgs = ((InternalEObject)outputs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RulesPackage.ACTION_TYPE1__OUTPUTS, null, msgs);
            if (newOutputs != null)
                msgs = ((InternalEObject)newOutputs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RulesPackage.ACTION_TYPE1__OUTPUTS, null, msgs);
            msgs = basicSetOutputs(newOutputs, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.ACTION_TYPE1__OUTPUTS, newOutputs, newOutputs));
    }
    ...
    public void setOperation(String newOperation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.ACTION_TYPE1__OPERATION, oldOperation, operation));
    }
    ...
    public void setType(ActionType newType) {
        ...
        typeESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.ACTION_TYPE1__TYPE, oldType, type, !oldTypeESet));
    }
    ...
    public void unsetType() {
        ...
        typeESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, RulesPackage.ACTION_TYPE1__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
    }
