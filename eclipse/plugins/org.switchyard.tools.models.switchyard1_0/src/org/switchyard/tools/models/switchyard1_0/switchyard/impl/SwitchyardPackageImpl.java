...
public class SwitchyardPackageImpl extends EPackageImpl implements SwitchyardPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDocumentRoot_PreferLocal(), theXMLTypePackage.getBoolean(), "preferLocal", "true", 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
