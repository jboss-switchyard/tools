 ...
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.rules.impl.ManifestTypeImpl#isScan <em>Scan</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ManifestTypeImpl extends CommonExtensionBaseImpl implements ManifestType {
    ...
    public void setScan(boolean newScan) {
        ...
        scanESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.MANIFEST_TYPE__SCAN, oldScan, scan, !oldScanESet));
    }
    ...
    public void unsetScan() {
        ...
        scanESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, RulesPackage.MANIFEST_TYPE__SCAN, oldScan, SCAN_EDEFAULT, oldScanESet));
    }
