 ...
 * <ul>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.file.impl.BaseCamelBindingImpl#getCamelContextMapper <em>Camel Context Mapper</em>}</li>
 *   <li>{@link org.switchyard.tools.models.switchyard1_0.camel.file.impl.BaseCamelBindingImpl#getCamelMessageComposer <em>Camel Message Composer</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BaseCamelBindingImpl extends SwitchYardBindingTypeImpl implements BaseCamelBinding {
    ...
    public NotificationChain basicSetCamelContextMapper(ContextMapperType newCamelContextMapper, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FilePackage.BASE_CAMEL_BINDING__CAMEL_CONTEXT_MAPPER, oldCamelContextMapper, newCamelContextMapper);
    ...
    public void setCamelContextMapper(ContextMapperType newCamelContextMapper) {
        if (newCamelContextMapper != camelContextMapper) {
            ...
            if (camelContextMapper != null)
                msgs = ((InternalEObject)camelContextMapper).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FilePackage.BASE_CAMEL_BINDING__CAMEL_CONTEXT_MAPPER, null, msgs);
            if (newCamelContextMapper != null)
                msgs = ((InternalEObject)newCamelContextMapper).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FilePackage.BASE_CAMEL_BINDING__CAMEL_CONTEXT_MAPPER, null, msgs);
            msgs = basicSetCamelContextMapper(newCamelContextMapper, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FilePackage.BASE_CAMEL_BINDING__CAMEL_CONTEXT_MAPPER, newCamelContextMapper, newCamelContextMapper));
    }
    ...
    public NotificationChain basicSetCamelMessageComposer(MessageComposerType newCamelMessageComposer, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FilePackage.BASE_CAMEL_BINDING__CAMEL_MESSAGE_COMPOSER, oldCamelMessageComposer, newCamelMessageComposer);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setCamelMessageComposer(MessageComposerType newCamelMessageComposer) {
        if (newCamelMessageComposer != camelMessageComposer) {
            ...
            if (camelMessageComposer != null)
                msgs = ((InternalEObject)camelMessageComposer).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FilePackage.BASE_CAMEL_BINDING__CAMEL_MESSAGE_COMPOSER, null, msgs);
            if (newCamelMessageComposer != null)
                msgs = ((InternalEObject)newCamelMessageComposer).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FilePackage.BASE_CAMEL_BINDING__CAMEL_MESSAGE_COMPOSER, null, msgs);
            msgs = basicSetCamelMessageComposer(newCamelMessageComposer, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FilePackage.BASE_CAMEL_BINDING__CAMEL_MESSAGE_COMPOSER, newCamelMessageComposer, newCamelMessageComposer));
    }
