...
public class ReferencePropertySource implements IPropertySource {
    ...
    static {
        DESCRIPTORS = new PropertyDescriptor[] {new PropertyDescriptor(PROP_MODEL, "SwitchYard Reference") };
        DESCRIPTORS[0].setDescription("SwitchYard service reference details.");
    }
}
