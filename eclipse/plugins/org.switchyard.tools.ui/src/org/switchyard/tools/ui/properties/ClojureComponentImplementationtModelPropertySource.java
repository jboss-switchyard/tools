...
public class ClojureComponentImplementationtModelPropertySource implements IPropertySource {
    ...
    private static final String PROP_SCRIPT_FILE = "script-file";
    ...
    static {
        DESCRIPTORS = new PropertyDescriptor[] {new PropertyDescriptor(PROP_SCRIPT_FILE, "Script File") };
        DESCRIPTORS[0].setDescription("The file containing the Clojure script.");
    }
}
