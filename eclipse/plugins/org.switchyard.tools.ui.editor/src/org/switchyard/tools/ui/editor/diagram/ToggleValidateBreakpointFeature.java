...
/**
 * ToggleValidateBreakpointFeature
 * <p/>
 * Toggles a validate breakpoint on the project.
 */
public class ToggleValidateBreakpointFeature extends AbstractCustomFeature implements ICustomFeature {
    ...
    /**
     * Create a new ToggleValidateBreakpointFeature.
     * 
     * @param fp the feature provider
     * @param context the context
     */
    public ToggleValidateBreakpointFeature(IFeatureProvider fp, ICustomContext context) {
        super(fp);
    ...
    public void execute(ICustomContext context) {
        ...
        if (_toDelete != null) {
            ...
            try {
                SwitchYardDebugUtil.createValidateBreakpoint(project);
            } catch (CoreException e) {
                final IDiagramContainer container = getDiagramBehavior().getDiagramContainer();
                final Shell shell;
                if (container instanceof SwitchyardSCAEditor) {
    ...
    public String getDescription() {
        return (_toDelete == null ? "Set" : "Clear") + " a validate breakpoint.";
    }

    @Override
    public String getImageId() {
        return ImageProvider.IMG_16_VALIDATE_WATCH;
    }
    ...
    public String getName() {
        return (_toDelete == null ? "Enable " : "Disable") + " Validate Breakpoint";
    }
