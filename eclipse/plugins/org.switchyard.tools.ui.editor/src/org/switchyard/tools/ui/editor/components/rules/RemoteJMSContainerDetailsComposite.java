 ...
 */
public class RemoteJMSContainerDetailsComposite extends AbstractChangeAwareModelComposite<RulesImplementationType> {
    ...
    private RulesExtraJaxbClassesTable _extraJaxbClassesTable;
    ...
    public RemoteJMSContainerDetailsComposite(ICompositeContainer container, Composite parent, int style, FormToolkit factory) {
        super(RulesImplementationType.class, container, parent, style);
        ...
        addModifyText(_deploymentIdText, RulesPackage.eINSTANCE.getRemoteType_DeploymentId());
        ...
        addModifyText(_hostNameText, RulesPackage.eINSTANCE.getRemoteJmsType_HostName());
        ...
        addModifyText(_remotingPortText, RulesPackage.eINSTANCE.getRemoteJmsType_RemotingPort());
        ...
        addModifyText(_messagingPortText, RulesPackage.eINSTANCE.getRemoteJmsType_MessagingPort());
        ...
        addModifyText(_userNameText, RulesPackage.eINSTANCE.getRemoteType_UserName());
        ...
        addModifyText(_passwordText, RulesPackage.eINSTANCE.getRemoteType_Password());
        ...
        addModifyText(_timeoutText, RulesPackage.eINSTANCE.getRemoteType_Timeout());
        ...
        addModifyText(_useSSLCombo, RulesPackage.eINSTANCE.getRemoteJmsType_UseSsl());
        ...
        addModifyText(_keystorePasswordText, RulesPackage.eINSTANCE.getRemoteJmsType_KeystorePassword());
        ...
        addModifyText(_keystoreLocationText, RulesPackage.eINSTANCE.getRemoteJmsType_KeystoreLocation());
        ...
        addModifyText(_truststorePasswordText, RulesPackage.eINSTANCE.getRemoteJmsType_TruststorePassword());
        ...
        addModifyText(_truststoreLocationText, RulesPackage.eINSTANCE.getRemoteJmsType_TruststoreLocation());
        ...
        _extraJaxbClassesTable = new RulesExtraJaxbClassesTable(actionsSection, SWT.NONE);
    ...
    public void setRemoteJMS(RemoteJmsType remoteJMS) {
        if (remoteJMS == null) {
            remoteJMS = RulesFactory.eINSTANCE.createRemoteJmsType();
        }
