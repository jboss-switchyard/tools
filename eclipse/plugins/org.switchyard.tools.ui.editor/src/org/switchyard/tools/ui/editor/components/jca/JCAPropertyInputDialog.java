 ...
 * 
 */
public class JCAPropertyInputDialog extends TitleAreaDialog {
     ...
     */
    public JCAPropertyInputDialog(Shell parent) {
        super(parent);
    }
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        getShell().setText(Messages.title_jcaActivationSpecificationProperty);
    ...
    protected boolean validate() {
        ...
        if (_propertyNameText.getText().trim().isEmpty()) {
            setErrorMessage(Messages.error_emptyPropertyName);
        } else if (_propertyValueText.getText().trim().isEmpty()) {
            setErrorMessage(Messages.error_emptyPropertyValue);
        }
