 ...
 *
 */
public class SCADiagramAddReferenceInterfaceWizard extends BaseWizard {
    ...
    private SCADiagramAddReferenceInterfaceStartPage _startPage = null;
     ...
     * Constructor.
     */
    public SCADiagramAddReferenceInterfaceWizard() {
        super();
        initPages();
        setWindowTitle("New Reference Interface");
    }
    ...
    private void initPages() {
        _startPage = new SCADiagramAddReferenceInterfaceStartPage("start");
        _javaPage = new SCADiagramAddCompositeReferenceJavaPage(_startPage, "camel");
