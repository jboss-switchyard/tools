...
import org.switchyard.tools.ui.editor.diagram.binding.wizards.SOAPBindingWizard;
 ...
 * 
 * <p/>
 * Factory for creating new SOAP bindings.
 * 
 * @author Rob Cernich
 */
public class SOAPBindingFactory extends BaseTypeFactory<Binding, Contract, IBindingWizard> {

    @Override
    protected IBindingWizard createTypeWizard() {
        return new SOAPBindingWizard();
    }
