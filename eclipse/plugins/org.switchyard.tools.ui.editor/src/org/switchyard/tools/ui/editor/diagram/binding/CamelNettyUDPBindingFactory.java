...
import org.switchyard.tools.ui.editor.diagram.binding.wizards.CamelNettyUDPBindingWizard;
 ...
 * @author Rob Cernich
 */
public class CamelNettyUDPBindingFactory extends BaseTypeFactory<Binding, Contract, IBindingWizard> {

    @Override
    protected IBindingWizard createTypeWizard() {
        return new CamelNettyUDPBindingWizard();
    }
