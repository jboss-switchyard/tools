 ...
 * 
 */
public class BPMResultsTable extends Composite implements ICellModifier {
     ...
     */
    public BPMResultsTable(Composite parent, int style) {
     ...
     */
    public BPMResultsTable(Composite parent, int style, boolean isReadOnly) {
        super(parent, style);
        ...
        this._mAddButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                if (_propertyTreeTable.getInput() == null) {
                    ...
                    if (impl.getResults() == null) {
                        impl.setResults(BPMFactory.eINSTANCE.createResultsType());
                    }
                    _propertyTreeTable.setInput(impl.getResults().getMapping());
                }
            ...
            if (impl.eContainer() != null) {
                ...
                domain.getCommandStack().execute(new RecordingCommand(domain) {
                    ...
                    protected void doExecute() {
                        ...
                        impl.getResults().getMapping().add(newMapping);
        ...
        if (getTargetObject() instanceof BPMImplementationType) {
            ...
            if (impl.eContainer() != null) {
                ...
                domain.getCommandStack().execute(new RecordingCommand(domain) {
                    @Override
                    protected void doExecute() {
                        impl.getResults().getMapping().remove(actionToRemove);
                        getTreeViewer().refresh(true);
                    }
                });
            } else {
