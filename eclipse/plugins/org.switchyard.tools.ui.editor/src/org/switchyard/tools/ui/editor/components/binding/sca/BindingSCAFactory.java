 ...
 * 
 * <p/>
 * Factory for creating new SCA Bindings.
 */
public class BindingSCAFactory extends BaseTypeFactory<Binding, Contract, IBindingWizard> {

    @Override
    protected IBindingWizard createTypeWizard() {
        return new BindingSCAWizard();
    }
