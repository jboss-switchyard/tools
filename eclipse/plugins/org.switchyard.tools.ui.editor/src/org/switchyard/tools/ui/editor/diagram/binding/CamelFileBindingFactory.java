...
import org.switchyard.tools.ui.editor.diagram.binding.wizards.CamelFileBindingWizard;
 ...
 * @author Rob Cernich
 */
public class CamelFileBindingFactory extends BaseTypeFactory<Binding, Contract, IBindingWizard> {

    @Override
    protected IBindingWizard createTypeWizard() {
        return new CamelFileBindingWizard();
    }
