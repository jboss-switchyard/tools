 ...
 * 
 */
public class BPMParametersTable extends Composite implements ICellModifier {
    ...
    private static final String[] TREE_COLUMNS = new String[] {EXPRESSION_COLUMN, CONTEXTSCOPE_COLUMN, VARIABLE_COLUMN, EXPRESSION_TYPE_COLUMN };
     ...
     */
    public BPMParametersTable(Composite parent, int style) {
     ...
     */
    public BPMParametersTable(Composite parent, int style, boolean isReadOnly) {
        super(parent, style);
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                if (_propertyTreeTable.getInput() == null) {
                    ...
                    if (impl.getParameters() == null) {
                        impl.setParameters(BPMFactory.eINSTANCE.createParametersType());
                    }
                    _propertyTreeTable.setInput(impl.getParameters().getMapping());
                }
            ...
            if (impl.eContainer() != null) {
                ...
                domain.getCommandStack().execute(new RecordingCommand(domain) {
                    ...
                    protected void doExecute() {
                        MappingType newMapping = BPMFactory.eINSTANCE.createMappingType();
                        newMapping.setExpression("NewExpression");
                        impl.getParameters().getMapping().add(newMapping);
        ...
        if (getTargetObject() instanceof BPMImplementationType) {
            ...
            if (impl.eContainer() != null) {
                ...
                domain.getCommandStack().execute(new RecordingCommand(domain) {
                    @Override
                    protected void doExecute() {
                        impl.getParameters().getMapping().remove(actionToRemove);
                        getTreeViewer().refresh(true);
                    }
                });
            } else {
    ...
    public void modify(Object element, String property, final Object value) {
        if (element instanceof TreeItem && property.equalsIgnoreCase(EXPRESSION_COLUMN)) {
            ...
            fireChangedEvent(this);
            // validate();
        } else if (element instanceof TreeItem && property.equalsIgnoreCase(VARIABLE_COLUMN)) {
            final TreeItem ti = (TreeItem) element;
            if (getTargetObject() instanceof BPMImplementationType) {
                final BPMImplementationType impl = (BPMImplementationType) getTargetObject();
                if (impl.eContainer() != null) {
                    ...
                    domain.getCommandStack().execute(new RecordingCommand(domain) {
                        ...
                        protected void doExecute() {
                            MappingType parm = (MappingType) ti.getData();
                            setFeatureValue(parm, "variable", value);
                            getTreeViewer().refresh(true);
                        }
                    });
                } else {
