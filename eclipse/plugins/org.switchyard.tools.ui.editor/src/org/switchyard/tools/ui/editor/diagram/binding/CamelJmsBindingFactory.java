...
import org.switchyard.tools.ui.editor.diagram.binding.wizards.CamelJmsBindingWizard;
 ...
 * @author Rob Cernich
 */
public class CamelJmsBindingFactory extends BaseTypeFactory<Binding, Contract, IBindingWizard> {

    @Override
    protected IBindingWizard createTypeWizard() {
        return new CamelJmsBindingWizard();
    }
