...
import org.switchyard.tools.ui.editor.diagram.binding.wizards.CamelSqlBindingWizard;
 ...
 * @author Rob Cernich
 */
public class CamelSqlBindingFactory extends BaseTypeFactory<Binding, Contract, IBindingWizard> {

    @Override
    protected IBindingWizard createTypeWizard() {
        return new CamelSqlBindingWizard();
    }
