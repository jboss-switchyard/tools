...
import org.switchyard.tools.ui.editor.diagram.binding.wizards.CamelQuartzBindingWizard;
 ...
 * @author Rob Cernich
 */
public class CamelQuartzBindingFactory extends BaseTypeFactory<Binding, Contract, IBindingWizard> {

    @Override
    protected IBindingWizard createTypeWizard() {
        return new CamelQuartzBindingWizard();
    }
