...
/**
 * CamelSFTPBindingFactory
 * 
 * <p/>
 * Factory for creating new Camel FTPS bindings.
 * 
 * @author Rob Cernich
 */
public class CamelSFTPBindingFactory extends BaseTypeFactory<Binding, Contract, IBindingWizard> {

    @Override
    protected IBindingWizard createTypeWizard() {
        return new CamelSFTPBindingWizard();
    }
