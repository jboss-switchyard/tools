 ...
 * 
 * <p/>
 * Factory for creating new Camel Mail bindings.
 * 
 * @author bfitzpat
 */
public class CamelMailBindingFactory extends BaseTypeFactory<Binding, Contract, IBindingWizard> {

    @Override
    protected IBindingWizard createTypeWizard() {
        return new CameMailBindingWizard();
    }
