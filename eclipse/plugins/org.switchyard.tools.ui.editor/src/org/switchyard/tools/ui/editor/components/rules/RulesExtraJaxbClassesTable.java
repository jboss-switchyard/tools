 ...
 * 
 */
public class RulesExtraJaxbClassesTable extends Composite implements ICellModifier {
     ...
     */
    public RulesExtraJaxbClassesTable(Composite parent, int style) {
     ...
     */
    public RulesExtraJaxbClassesTable(Composite parent, int style, boolean isReadOnly) {
        super(parent, style);
            ...
            if (impl.eContainer() != null) {
                ...
                domain.getCommandStack().execute(new RecordingCommand(domain) {
                    ...
                    protected void doExecute() {
                        ...
                        if (impl.getExtraJaxbClasses() == null) {
                            impl.setExtraJaxbClasses(RulesFactory.eINSTANCE.createExtraJaxbClassesType());
                        }
