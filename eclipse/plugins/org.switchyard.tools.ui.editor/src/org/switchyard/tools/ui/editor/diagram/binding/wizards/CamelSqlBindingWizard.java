 ...
 * @author bfitzpat
 */
public class CamelSqlBindingWizard extends LinkedWizardBase implements IBindingWizard {

    private CamelSqlBindingWizardPage _page;
    private Contract _container;

    @Override
    public void addPages() {
        _page = new CamelSqlBindingWizardPage(CamelSqlBindingWizardPage.class.getCanonicalName());
        addPage(_page);
    }
