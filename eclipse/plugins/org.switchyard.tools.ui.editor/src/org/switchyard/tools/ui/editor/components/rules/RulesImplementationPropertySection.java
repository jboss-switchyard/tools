 ...
 * 
 * Property sheet composite for Rules component implementations.
 */
public class RulesImplementationPropertySection extends AbstractTabbedPropertySection<Component> {

    @Override
    protected AbstractModelComposite<Component> createComposite(Composite parent, int style) {
        return new RulesImplementationComposite(this, parent, style);
    }
