 ...
 * 
 */
public class RulesGlobalTable extends Composite implements ICellModifier {
     ...
     */
    public RulesGlobalTable(Composite parent, int style) {
     ...
     */
    public RulesGlobalTable(Composite parent, int style, boolean isReadOnly) {
        super(parent, style);
        ...
        this._mAddButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                if (_propertyTreeTable.getInput() == null) {
                    ...
                    if (impl.getGlobals() == null) {
                        impl.setGlobals(RulesFactory.eINSTANCE.createGlobalsType());
                    }
                    _propertyTreeTable.setInput(impl.getGlobals().getMapping());
                }
            ...
            if (impl.eContainer() != null) {
                ...
                domain.getCommandStack().execute(new RecordingCommand(domain) {
                    ...
                    protected void doExecute() {
                        ...
                        impl.getGlobals().getMapping().add(newMapping);
        ...
        if (getTargetObject() instanceof RulesImplementationType) {
            ...
            if (impl.eContainer() != null) {
                ...
                domain.getCommandStack().execute(new RecordingCommand(domain) {
                    @Override
                    protected void doExecute() {
                        impl.getGlobals().getMapping().remove(actionToRemove);
                        getTreeViewer().refresh(true);
                    }
                });
            } else {
