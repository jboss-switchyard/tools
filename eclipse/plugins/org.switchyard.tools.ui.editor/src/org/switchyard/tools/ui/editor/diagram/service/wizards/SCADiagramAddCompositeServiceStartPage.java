 ...
 * 
 */
public class SCADiagramAddCompositeServiceStartPage extends BaseWizardPage {

    private Text _compositeServiceNameText;
    private String _compositeServiceName = null;
     ...
     */
    protected SCADiagramAddCompositeServiceStartPage(String pageName) {
        super(pageName);
        setTitle("Create a New Composite Service");
        setDescription("Specify the name and interface details for the new composite service.");
    }
    ...
    public void createControl(Composite parent) {
        ...
        _compositeServiceNameText = new Text(composite, SWT.BORDER);
        _compositeServiceNameText.addModifyListener(new ModifyListener() {
            public void modifyText(ModifyEvent e) {
                handleModify();
            }
        });

        _compositeServiceNameText.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
    ...
    public String getCompositeServiceName() {
        return this._compositeServiceName;
    }
    ...
    private void handleModify() {
        _compositeServiceName = _compositeServiceNameText.getText().trim();
        validate();
    }

    private void validate() {
        String errorMessage = null;
        String cpName = _compositeServiceNameText.getText();
