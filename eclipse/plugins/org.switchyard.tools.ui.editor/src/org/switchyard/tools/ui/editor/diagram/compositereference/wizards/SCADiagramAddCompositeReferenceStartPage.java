 ...
 * 
 */
public class SCADiagramAddCompositeReferenceStartPage extends BaseWizardPage {

    private Text _compositeReferenceNameText;
    private String _compositeReferenceName = null;
     ...
     */
    protected SCADiagramAddCompositeReferenceStartPage(String pageName) {
        super(pageName);
        setTitle("Create a New Composite Reference");
        setDescription("Specify the name and interface details for the new composite reference.");
    }
    ...
    public void createControl(Composite parent) {
        ...
        _compositeReferenceNameText = new Text(composite, SWT.BORDER);
        _compositeReferenceNameText.addModifyListener(new ModifyListener() {
            public void modifyText(ModifyEvent e) {
                handleModify();
            }
        });

        _compositeReferenceNameText.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
    ...
    public String getCompositeReferenceName() {
        return this._compositeReferenceName;
    }
    ...
    private void handleModify() {
        _compositeReferenceName = _compositeReferenceNameText.getText().trim();
        validate();
    }

    private void validate() {
        String errorMessage = null;
        String cpName = _compositeReferenceNameText.getText();
