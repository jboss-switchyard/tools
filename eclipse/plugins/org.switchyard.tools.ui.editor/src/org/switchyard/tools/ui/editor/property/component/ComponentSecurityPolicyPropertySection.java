 ...
 * 
 */
public class ComponentSecurityPolicyPropertySection extends AbstractTabbedPropertySection<Component> {

    @Override
    protected AbstractModelComposite<Component> createComposite(Composite parent, int style) {
        return new ComponentSecurityPolicyComposite(this, parent, style);
    }
}
