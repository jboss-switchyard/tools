...
/**
 * CamelAtomBindingFactory
 * 
 * <p/>
 * Factory for creating new Camel Atom bindings.
 * 
 * @author bfitzpat
 */
public class CamelAtomBindingFactory extends BaseTypeFactory<Binding, Contract, IBindingWizard> {

    @Override
    protected IBindingWizard createTypeWizard() {
        return new CamelAtomBindingWizard();
    }
